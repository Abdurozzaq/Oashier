                ...
                <v-row>
                  <v-col cols="12">
                    ...
                    <v-text-field
                      ...
                      @input="$v.restaurant_name.$touch()" 
                      @blur="$v.restaurant_name.$touch()"
                    ></v-text-field>
                  </v-col>
                </v-row>
              </v-card-text>
    ...
    export default {
        ...
        computed: {
            ...
            restaurantNameErrors () {
                let currentObj = this
                const errors = []
                if (!currentObj.$v.restaurant_name.$dirty) return errors
                !currentObj.$v.restaurant_name.required && errors.push('Restaurant Name is required.')
                return errors
            },
        }, // End of Computed
        ...
        methods: {  
            ...
            getIdentity: function() {
                ...
                .then(function (response) {
                    ...
                    currentObj.restaurant_name = response.data.user.restaurant_name
